...
description p = case p of
  ...
  FxpStatus i code msg tag bs -> show code ++ " " ++ T.unpack msg ++ " "
    ++ show tag ++ " " ++ take 64 (show bs)
...
fxOk, fxEof, fxNoSuchFile, fxPermissionDenied, fxFailure, fxBadMessage,
  fxNoConnection, fxConnectionLost, fxOpUnsupported :: Word32
fxOk = 0
fxEof = 1
fxNoSuchFile = 2
...
fxBadMessage = 5
fxNoConnection = 6
fxConnectionLost = 7 -- Never actually generated by the server.
fxOpUnsupported = 8
